...
procName_Str = 'api_server-asan'
procStartCmd_Str = '/home/kali/fuzzing/victims/mongoose-6.13/bin/api_server-asan'
procStopCmd_Str = 'killall api_server-asan'
...
print("time: " + time_Str)
sessionFileName_Str = time_Str + ".rest_mong.session"
