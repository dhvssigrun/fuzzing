...
procName_Str = 'simplest_web_server-asan32'
procStartCmd_Str = '/home/kali/fuzzing/victims/mongoose-6.13/bin/simplest_web_server-asan32'
procStopCmd_Str = 'killall simplest_web_server-asan32'
...
print("time: " + time_Str)
sessionFileName_Str = time_Str + ".mongoose_sws.session"
