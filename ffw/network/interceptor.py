...
class Interceptor(object):
    ...
    def _performUdpIntercept(self, localHost, localPort, targetHost, targetPort):
        ...
        logging.info("Listening on udp: " + str(localHost) + " : " + str(localPort))
        ...
        while True:
            try:
                try:
                    ...
                    #dataArr.append( self.createDataEntry("cli", data, n) ) added by me
		    dataArr.append( NetworkData.createNetworkMessage("cli", data, n) )	
                    n += 1
			...
			dataArr.append( NetworkData.createNetworkMessage("srv", data, n) )	
